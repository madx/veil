...
bootstrap:
	...
	@ curl -s https://raw.githubusercontent.com/skw/normalize.stylus/master/normalize.styl -o sources/stylesheets/_normalize.styl
	...
	@ curl -s https://raw.githubusercontent.com/madx/veil/master/skel/default.jade -o sources/layouts/default.jade
	@ $(ECHO) "  sources/layout/default.jade"
	@ curl -s https://raw.githubusercontent.com/madx/veil/master/skel/index.jade -o sources/pages/index.jade
	@ $(ECHO) "  sources/pages/index.jade"
	@ curl -s https://raw.githubusercontent.com/madx/veil/master/skel/stylesheet.styl -o sources/stylesheets/stylesheet.styl
...
upgrade:
	...
	@ curl -s https://raw.githubusercontent.com/madx/veil/master/Makefile > Makefile
	@ $(ECHO) "$(COL_G)✓ Done$(ENDC)"
